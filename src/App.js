  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="flex flex-col-reverse md:flex-row items-center md:space-x-8">
      ...
      <div className="md:w-1/2">
        ...
        <p className="mt-4">
          Drag and drop or select your HW in
          PDF format! StudyBoost's intuitive interface makes it simple to
          upload your files and start the AI-driven note generation process.
        </p>
      </div>
    </div>
    {/* Feature 2 */}
    <div className="flex flex-col md:flex-row items-center md:space-x-8">
      ...
      <div className="md:w-1/2">
        ...
        <p className="mt-4">
          ...
          searching for terms, formulas, descriptions etc. and focus on learning and solving the problems more efficiently.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="flex flex-col items-center">
    ...
    <div className="w-full md:w-2/3 text-center">
      ...
      <p>
        ...
        coding like me, please consider using another free tool that I have
        made called{" "}
        <a
        ...
        . It helps you document, explain, optimize, and debug code thanks to
        AI.
      </p>
      <p className="mt-4">
        If you like my work, consider following me on Twitter or buying me a
        coffee.
      </p>
