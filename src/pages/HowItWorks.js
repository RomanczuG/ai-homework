...
export const HowItWorks = () => {
  return (
    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <p className="mb-4">
      StudySmarterNow.com is designed to help college students achieve academic success by providing personalized study tips, learning strategies, and test-taking strategies. Here's how our platform works:
      </p>
      <ol className="list-decimal list-outside pl-6 mb-4">
        ...
        <li className="mb-2">
          <strong>Personalized study tips and learning strategies:</strong> Based on the AI analysis, StudySmarterNow.com generates a comprehensive study guide with tailored study tips and learning strategies to help you excel in your coursework.
        </li>
        {/* <li className="mb-2">
