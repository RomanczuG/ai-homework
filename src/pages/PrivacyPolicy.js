  ...
  return (
    <div className="bg-[#252D62] min-h-screen text-white">
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <p className="mb-4">
          Your privacy is important to us. It is StudySmarterNow.com's policy to respect your privacy regarding any information we may collect from you across our website, <a href="https://studyboost.app">https://studyboost.app</a>, and other sites we own and operate.
        </p>
        <p className="mb-4">
