...
export const FeaturesSection = () => {
  return (
    <section
      id="features"
      className="mx-auto px-20 py-20 text-black bg-[#F0FFE0]"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col items-center text-center border-r-2 border-gray-200 md:border-none">
          ...
          <h3 className="text-2xl font-semibold">AI-Powered Study Strategies</h3>
          <p className="mt-4">
        ...
        <div className="flex flex-col items-center text-center border-r-2 border-gray-200 md:border-none">
          ...
          <h3 className="text-2xl font-semibold">Easy Homework and Test Upload</h3>
          <p className="mt-4">
        ...
        <div className="flex flex-col items-center text-center border-r-2 border-gray-200 md:border-none">
          ...
          <h3 className="text-2xl font-semibold">Comprehensive Study Notes</h3>
          <p className="mt-4">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-2xl font-semibold">Improved Test-Taking Skills</h3>
          <p className="mt-4">
